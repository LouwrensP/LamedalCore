...
namespace LamedalCore.domain.Attributes
{
    public static class enumValue_Controller
    {
        ...
        public static bool zValue_AsInt(this Enum enumValue, out int value, out int attValue1, out int attValue2)
        {
            ...
            var enumValueAttributes = (enumValue_Attribute[])(enumValue.GetType().GetTypeInfo().GetField(enumValue.ToString())).GetCustomAttributes(typeof(enumValue_Attribute), false);
