...
namespace LamedalCore.Types.Class
{
    ...
    public sealed class Class_AsString
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Class_AsString"/> class.
        /// </summary>
        /// <param name="indentSize">Size of the indent.</param>
        /// <param name="maxLength">The maximum length.</param>
        /// <param name="maxItemCount">The maximum item count.</param>
        private Class_AsString(int indentSize = 2, int maxLength = 250, int maxItemCount = 20)
        {
        ...
        private string DumpElement(object element)
        {
            ...
            else
            {
                ...
                if (typeof(IEnumerable).GetTypeInfo().IsAssignableFrom(objectType) == false)
                {
                    Write("---------------------------------------------------------------------------");
                ...
                {
                    var members = element.GetType().GetTypeInfo().GetMembers(BindingFlags.Public | BindingFlags.Instance);
        ...
        private string FormatValue(object o)
        {
            ...
            if (o is DateTime) return (((DateTime)o).ToString());
