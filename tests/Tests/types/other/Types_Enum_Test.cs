...
using LamedalCore.Test.Tests.types.other.data;
using LamedalCore.zz;
using Xunit;

namespace LamedalCore.Test.Tests.types.other
{
    public partial class xTypes_Other // Types_Enum_Test
    {
        [Fact]
        ...
        public void Str_2EnumValue_Test()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => _lamed.Types.Enum.Str_2EnumValue< enBlueprint_ClassNetworkType>("Illigal value"));
        }
